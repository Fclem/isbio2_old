...
urlpatterns = patterns('',
    ...
    url(r'^reports/ownreports', views.ownreports),
    url(r'^reports/accessreports', views.accessreports),
    ...
    url(r'^shiny/(?P<path>.*)$', views.proxy_to, {'target_url': 'http://127.0.0.1:3838/sample-apps/'}),
