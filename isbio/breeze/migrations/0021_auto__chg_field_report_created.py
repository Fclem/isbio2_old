...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Report.created'
        db.alter_column('breeze_report', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Report.created'
        db.alter_column('breeze_report', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
