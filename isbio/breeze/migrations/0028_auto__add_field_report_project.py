...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('breeze_report', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['breeze.Project'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.project'
        db.delete_column('breeze_report', 'project_id')
