...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rscripts.inln'
        db.alter_column('breeze_rscripts', 'inln', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'Rscripts.details'
        db.alter_column('breeze_rscripts', 'details', self.gf('django.db.models.fields.CharField')(max_length=5500))

    def backwards(self, orm):

        # Changing field 'Rscripts.inln'
        db.alter_column('breeze_rscripts', 'inln', self.gf('django.db.models.fields.CharField')(max_length=75))

        # Changing field 'Rscripts.details'
        db.alter_column('breeze_rscripts', 'details', self.gf('django.db.models.fields.CharField')(max_length=350))
