...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('breeze_userprofile', 'first_name')

        # Deleting field 'UserProfile.last_name'
        db.delete_column('breeze_userprofile', 'last_name')


    def backwards(self, orm):
        # Adding field 'UserProfile.first_name'
        db.add_column('breeze_userprofile', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 5, 9, 0, 0), max_length=35),
                      keep_default=False)

        # Adding field 'UserProfile.last_name'
        db.add_column('breeze_userprofile', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 5, 9, 0, 0), max_length=35),
                      keep_default=False)
