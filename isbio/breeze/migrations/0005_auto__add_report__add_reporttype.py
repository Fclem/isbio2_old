...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('breeze_report', (
            ...
            ('rexec', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
    ...
    models = {
        ...
        'breeze.report': {
            ...
            'rexec': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
        ...
        'breeze.reporttype': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '350', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['breeze.Rscripts']", 'symmetrical': 'False'}),
