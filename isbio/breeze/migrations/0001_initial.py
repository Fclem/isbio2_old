...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('breeze_rscripts', (
            ...
            ('inln', self.gf('django.db.models.fields.CharField')(max_length=75)),
            ('details', self.gf('django.db.models.fields.CharField')(max_length=350)),
            ...
            ('header', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
    ...
    models = {
        ...
        'breeze.rscripts': {
            ...
            'details': ('django.db.models.fields.CharField', [], {'max_length': '350'}),
            'docxml': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'header': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inln': ('django.db.models.fields.CharField', [], {'max_length': '75'}),
