...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Jobs.staged'
        db.alter_column('breeze_jobs', 'staged', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Jobs.staged'
        db.alter_column('breeze_jobs', 'staged', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
