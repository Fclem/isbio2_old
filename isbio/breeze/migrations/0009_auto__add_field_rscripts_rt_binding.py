...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field tags on 'ReportType'
        db.delete_table('breeze_reporttype_tags')

        # Adding field 'Rscripts.rt_binding'
        db.add_column('breeze_rscripts', 'rt_binding',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['breeze.ReportType']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding M2M table for field tags on 'ReportType'
        db.create_table('breeze_reporttype_tags', (
        ...
        db.create_unique('breeze_reporttype_tags', ['reporttype_id', 'rscripts_id'])

        # Deleting field 'Rscripts.rt_binding'
        db.delete_column('breeze_rscripts', 'rt_binding_id')
    ...
    models = {
        ...
        'breeze.rscripts': {
            ...
            'rt_binding': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['breeze.ReportType']"})
        },
        'breeze.userprofile': {
