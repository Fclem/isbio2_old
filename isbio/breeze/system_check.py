...
CHECK_LIST = [
	...
	# 			ui_text=good_bad),
	# SysCheckUnit(check_sge_c, 'sge_c', '', 'SGE CONFIG\t\t', RunType.disabled, ex=SGEImproperlyConfigured),
	#  boot_time
	...
	# SysCheckUnit(check_csc_taito_mount, 'csc_taito_mount', 'CSC Taito File System', 'CSC TAITO FS\t\t',
	# RunType.runtime,
	# 			ex=FileSystemNotMounted),
