...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Report.search'
        db.delete_column('breeze_report', 'search')

        # Adding field 'ReportType.search'
        db.add_column('breeze_reporttype', 'search',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Report.search'
        db.add_column('breeze_report', 'search',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'ReportType.search'
        db.delete_column('breeze_reporttype', 'search')
