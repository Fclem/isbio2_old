...
urlpatterns = patterns('',
    ...
    url(r'^scripts/run/(?P<sid>\d+)$', views.run_script),
    url(r'^new/$', views.create),
    url(r'^sub-gen/$', views.validate_general),
    url(r'^sub-par/$', views.validate_details),
    url(r'^sub-src/$', views.validate_sources),
