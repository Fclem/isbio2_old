...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReportType.description'
        db.alter_column('breeze_reporttype', 'description', self.gf('django.db.models.fields.CharField')(max_length=5500))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ReportType.description'
        db.alter_column('breeze_reporttype', 'description', self.gf('django.db.models.fields.CharField')(max_length=350))
