...
class DevSettings(BreezeSettings):
	...
	SHINY_TARGET_URL = 'http://%s/breeze/'
	SHINY_LIBS_TARGET_URL = 'http://%s/libs/'
	SHINY_REMOTE_IP = '86.50.169.70:3838'
	SHINY_LOCAL_IP = '127.0.0.1:3838'
	SHINY_MODE = 'local'
	if SHINY_MODE == 'remote':
		SHINY_TARGET_URL = SHINY_TARGET_URL % SHINY_REMOTE_IP
		SHINY_LIBS_TARGET_URL = SHINY_LIBS_TARGET_URL % SHINY_REMOTE_IP
		SHINY_LIBS_BREEZE_URL = '/libs/'
	else:
		SHINY_TARGET_URL = SHINY_TARGET_URL % SHINY_LOCAL_IP
		SHINY_LIBS_TARGET_URL = SHINY_LIBS_TARGET_URL % SHINY_LOCAL_IP
