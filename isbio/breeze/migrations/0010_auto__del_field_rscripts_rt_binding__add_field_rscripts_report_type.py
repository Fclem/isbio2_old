...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Rscripts.report_type'
        db.add_column('breeze_rscripts', 'report_type',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Rscripts.report_type'
        db.delete_column('breeze_rscripts', 'report_type_id')
    ...
    models = {
        ...
        'breeze.rscripts': {
            ...
            'report_type': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['breeze.ReportType']"})
        },
        'breeze.userprofile': {
