...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rscripts.report_type'
        db.alter_column('breeze_rscripts', 'report_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['breeze.ReportType'], null=True))

    def backwards(self, orm):

        # Changing field 'Rscripts.report_type'
        db.alter_column('breeze_rscripts', 'report_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['breeze.ReportType']))
    ...
    models = {
        ...
        'breeze.rscripts': {
            ...
            'report_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['breeze.ReportType']", 'null': 'True', 'blank': 'True'})
        },
        'breeze.userprofile': {
