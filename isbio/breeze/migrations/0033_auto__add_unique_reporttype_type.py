...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ReportType', fields ['type']
        db.create_unique('breeze_reporttype', ['type'])


    def backwards(self, orm):
        # Removing unique constraint on 'ReportType', fields ['type']
        db.delete_unique('breeze_reporttype', ['type'])
